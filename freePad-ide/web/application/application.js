(function(window,$){
    ...
    $.freePad = $.pfc.webapp("freePad-ide", null, {        
        ...
        addExternalPage: function(href) {
                        ...
                        $.freePad.externalPagesCounter++;
                        
                if($('#'+pageid).hasClass('pfc-editor-dialog'))
                {
                       $.freePad.editor.activateTab(pageid);
                }
                else {
                        
                        $.freePad.editor.addActiveDialogTab($(this).text(),pageid);
                       ...
                       //$('#'+pageid+' .page-preview-browser-holder').first().width((parseInt($('#pfc-editor-body').width())-50)+"px");    
                        ...
                        $.freePad.editor.ui.openDialogsTabsListeners({pageid:pageid,close:function(){}});
            ...
            sectionsHeadMenuListeners: function() {               
               $('.pfc-editor-section-header li a').unbind('click').click(function(){                 
                 ...
                 {                   
                   ...
                   if($.freePad.getSection($(this).closest('.pfc-editor-section').attr('id')) && 
                     typeof $.freePad.getSection($(this).closest('.pfc-editor-section').attr('id')).focus === 'function')
                   $.freePad.getSection($(this).closest('.pfc-editor-section').attr('id')).focus();
                 }
