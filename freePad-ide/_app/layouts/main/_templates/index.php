...
use freePad\Config\WebAppConfig;
use freePad\Config\SourcesConfig;
use freePad\Config\UserData\Settings;
...
<html>
    <head>
        ...
        <title>freePad IDE :: web development tool</title>
    ...
    <body class="freePad-ide-theme-<?php echo Settings::theme(); ?>">

        <div class="freePad-ide-booting">
          <div class="freePad-ide-booting-inner-holder">  
            <?php echo _tr('booting <em>free</em>Pad IDE... please wait...'); ?>
            <div class="freePad-ide-booting-holder">
              <div class="freePad-ide-booting-inner">
                <div class="freePad-ide-booting-prct"></div>
              </div>
            </div>
          </div>    
        </div>
    ...
    <header class="freePad-ide-webapp-header">           		        
        <?php echo $this->component('application/header'); ?>			        
    </header> 
    <!-- freePad-ide-webapp-head -->
                          
    <aside class="freePad-ide-webapp-left-panel">   
        <?php //echo $this->component('sections/sources'); ?>              
    </aside> 
    <!-- freePad-ide-webapp-left-panel -->
        
    <aside class="freePad-ide-webapp-right-panel">
        <?php //echo $this->component('tools'); ?>
    </aside> 
    <!-- freePad-ide-webapp-right-panel -->   
                   
    <section class="freePad-ide-webapp-content">      
        <?php //echo $this->component('editor'); ?>    
    </section>                            
    <!-- MAIN -->     
      
    <footer class="freePad-ide-webapp-footer">
    ...
    <script type="text/javascript" src="vendor/fileTree/jqueryFileTree.js"></script>
      	...
      	<script  type="text/javascript">
            (function($) {    
                  $('.freePad-ide-booting-prct').css('width','18px');
              })(jQuery);
      	</script>
    ...
    <!-- end ace editor -->  
        ...
        <script  type="text/javascript">
            (function($) {    
                    $('.freePad-ide-booting-prct').css('width','50px');
                })(jQuery);
        </script>
    ...
    <!-- end libararies javascript -->
        ...
        <script  type="text/javascript">
          (function($) {      
                $('.freePad-ide-booting-prct').css('width','88px');
            })(jQuery);
        </script>
    ...
    <!-- SECTIONS -->      
        ...
        <script  type="text/javascript">
          (function($) {      
                 $('.freePad-ide-booting-prct').css('width','108px');
            })(jQuery);
        </script>
    ...
    <!-- PAGES -->        
        ...
        <script  type="text/javascript">
          (function($) {    
                $('.freePad-ide-booting-prct').css('width','128px');
            })(jQuery);     
        </script>
            
<!-- freePad IDE BOOTSTRAP -->            
<script type="text/javascript">
(function($) {              
    //configure                        
                   
    //loading bar move               
    $('.freePad-editor-booting-prct').css('width','138px');          
              
    //lets boot
    $.freePad.init(function(that){    
        setTimeout(function(){                            
            
            //END BOOTING
            $('.freePad-editor-booting').css('left','15000px');
