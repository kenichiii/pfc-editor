...
(function(window,$){
    ...
    $.pfcEditor = {        
        ...
        getLocalStorageImageKey: function() {
          return "__freePadEditorImageKey" + this.user.login; 
        },
        ...
        writeImage: function() {
            var image = {
                editorBar: this.editor.editorBar,
        ...
        init: function(callback) {
            ...
            if(localStorage && this.getLocalStorageImage()) {
                    
                var image = this.getLocalStorageImage();
                
                for(var li = 0; li < image.editorBar.length; li++) {
                    if(image.editorBar[li].type == 'file') {
                        this.editor.openfile(image.editorBar[li].file_path,image.editorBar[li].root,image.editorBar[li].ext);
                    } else if(image.editorBar[li].type == 'page') {
                        this.editor.addPage(this.getPage(image.editorBar[li].page.pageid),image.editorBar[li].ext);                        
                    }                   
                }
                
                //set active activeEditorBarTab
                ...
                $('#pfc-editor-dialogs-heads a[href="#free-pad_editor-home"]').text('Welcome');
