...
<html>
    <head>
        ...
        <!-- pfc EDITOR -->        
        <link href="application/layout/main/css/layout.css" rel="stylesheet" type="text/css"/>        
        ...
        <!-- PAGES -->
        <link href="application/components/pages/pfc-editor/editor-about/about.css" rel="stylesheet" type="text/css"/>
        <link href="application/components/pages/pfc-editor/editor-config/config.css" rel="stylesheet" type="text/css"/>
    ...
    <!-- pfc EDITOR -->        
    <script src="application/sounds/manager.js" type="text/javascript"></script>
            
    <script src="application/components/pfc-editor.js" type="text/javascript"></script>

    <script src="application/components/editor/code.editor.js"></script>             
    <script src="application/theme/<?php echo Settings::theme; ?>/ace.editor.config.js" type="text/javascript"></script>                               
    <script src="<?php echo Router::editorlinkpjs('ace-editor-config'); ?>" type="text/javascript"></script>                               
    
    <!-- TOOLS -->        
    <script src="application/components/tools/default-apps/tools.js" type="text/javascript"></script>
    <script src="application/components/tools/default-apps/snippets/snippets.js" type="text/javascript"></script>
      
    <!-- SECTIONS -->  
    <script src="application/components/sections/sources/sources.js" type="text/javascript"></script>
    ...
    <!-- PAGES -->        
    <script src="application/components/pages/free-pad/editor-about/editor-about.js" type="text/javascript"></script>
    <script src="application/components/pages/free-pad/editor-config/editor-config.js" type="text/javascript"></script>
    <script src="application/components/pages/free-pad/editor-help/editor-help.js" type="text/javascript"></script>
    <script src="application/components/pages/free-pad/editor-home/editor-home.js" type="text/javascript"></script>
            
    <script src="application/components/pages/phpinfo/phpinfo.js" type="text/javascript"></script>            
            
    <script src="application/components/pages/adminer/adminer.js" type="text/javascript"></script>            
            
    <script src="application/components/pages/webconsole/webconsole.js" type="text/javascript"></script> 
...
(function(window, $) {      
    //configure
        ...
        //pages
        $.pfcEditor.getPage('free-pad_editor-home').config.url = '<?php echo Router::pagelink('free-pad/editor-home'); ?>';
        $.pfcEditor.getPage('free-pad_editor-about').config.url = '<?php echo Router::pagelink('free-pad/editor-about'); ?>';
        $.pfcEditor.getPage('free-pad_editor-config').config.url = '<?php echo Router::pagelink('free-pad/editor-config'); ?>';
        $.pfcEditor.getPage('free-pad_editor-help').config.url = '<?php echo Router::pagelink('free-pad/editor-help'); ?>';
    ...
    $.pfcEditor.init(function(that){    
        setTimeout(function(){                            
            ...
            $.pfcEditor.ui.alert('Welcome to idePad demo<br><br>use dblclick on left panel files or folders to see some action<br><br>or click some right panel application or some top menu<br><br>ENJOY!!!',{autohide:false})
