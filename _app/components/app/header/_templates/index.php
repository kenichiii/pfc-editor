...
?>
            ...
            <nav>
                ...
                <ul id="pfc-editor-menu">                    
                    ...
                    <li><a id="pfc-sources-sandbox-href"  href="#pfc-sources-sandbox-src"><?php echo _tr('sandbox'); ?></a></li>                    
                    ...
                    <li><a id="pfc-sources-my-home-href" href="#pfc-sources-my-home-src"><?php echo _tr('my home'); ?></a></li>
                </ul>            
